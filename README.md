# Операционные системы UNIX/Linux (Сам отчет находится в ветке develop)

Установка и обновления системы Linux. Основы администрирования (Базового).
...
### (Историческая справка и немного теории)
...
\> *Чтобы не переустанавливать операционную систему, использовать виртуальную машину*
...
\> *Ещё некоторое количество полезной информации анходится е папке materials*
...
##### Используя каждый из трех выбранных редакторов, создайте файл *test_X.txt*, где X -- название редатктора, в котором создан файл. Напишите в нём свой никнейм, закройте файл с сохранением изменений.  
...
`-` df - не единственный способ получить информацию о дисковом пространстве.
